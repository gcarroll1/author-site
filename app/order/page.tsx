  ...
  return (<>
    ...
    <article className="prose prose-invert max-w-none">
      ...
      <div className="grid md:grid-cols-3 gap-4">
        ...
        <Link href="/order/arc" className="card"><div className="p-5 bg-neutral-900 border border-neutral-800 rounded-xl h-full"><h3 className="font-semibold text-lg mb-1">Advance Reader (ARC)</h3><p className="text-sm text-neutral-300">Register for an advance copy.</p></div></Link>
